    ...
    <ul class="nav navbar-nav float-right">
     ...
     <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
      ...
      <div class="dropdown-menu dropdown-menu-right">
       <?php if ($auth->value == '1') : ?>
       <a class="dropdown-item" href="admin_profile.php"><i class="ft-user"></i> AdminProfile</a>
       <!-- user profile -->
       <?php elseif ($auth->value == '2') : ?>
       <a class="dropdown-item" href="user_profile.php"><i class="ft-user"></i> UserProfile</a>

       <?php endif; ?>
       <a class="dropdown-item" href="#"><i class="ft-clipboard"></i> Todo</a><a class="dropdown-item" href="#"><i
